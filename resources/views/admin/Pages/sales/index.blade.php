                        ...
                        <div class="card-body">
                            ...
                            <form action="#" method="POST" id="add_sale_form"
                                ...
                                <div class="submit-section" style="margin-top: 15px;margin-bottom: 20px;">
                                    ...
                                    <a type="submit" class="btn btn-primary" name="submit" id="add_sale_btn" 
                                    value="Submit" href="{{route('example1')}}">Submit</a>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="modal-body">
                    <form action="#" method="POST" id="add_Customer_form" enctype="multipart/form-data">
                        ...
                        <div class="submit-section">
                            <a class="btn btn-primary submit-btn" id="add_Customer_btn" type="submit"
